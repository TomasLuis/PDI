...
class Servico(models.Model):
    ...
    prestador = models.ForeignKey(Perfil, on_delete=models.CASCADE, related_name='servicos_prestados')  # ✅ ALTERADO
...
class Classificacao(models.Model):
    ...
    classificacao = models.IntegerField(choices=[(i, str(i)) for i in range(1, 6)])
